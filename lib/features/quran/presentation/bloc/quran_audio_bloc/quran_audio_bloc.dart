...
class QuranAudioBloc extends HydratedBloc<QuranAudioEvent, QuranAudioState> {
  ...
  Future<void> _handlePlayAyah(
      PlayAyah event, Emitter<QuranAudioState> emit) async {
    emit(state.copyWith(
  ...
  Future<void> _handlePlaySurah(
      PlaySurah event, Emitter<QuranAudioState> emit) async {
    emit(state.copyWith(
