...
import 'package:amar_deen/core/widgets/custom_switch.dart';
import 'package:amar_deen/core/widgets/bottom_sheet_select.dart';
import 'package:amar_deen/features/quran/domain/entities/quran_audio_catalog.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<QuranThemeBloc, QuranThemeState>(
      builder: (context, state) {
        ...
        final value =
            ids.contains(state.audioEdition) ? state.audioEdition : fallbackId;
