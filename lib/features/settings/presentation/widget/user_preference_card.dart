...
import 'package:amar_deen/core/localization/locale_bloc/locale_bloc.dart';
import 'package:amar_deen/core/theme/theme_bloc/theme_bloc.dart';
...
import 'package:amar_deen/core/utils/timing_controller.dart';
                  ...
                  return ChangeLanguageSwitch(
                      ...
                      onChanged: (toBangla) {
                        BlocProvider.of<LocaleBloc>(context).add(
                          ChangeLocale(Locale(toBangla ? 'bn' : 'en')),
                        );
                      });
                },
              ),
