...
class LiveTvState extends Equatable {
  ...
  final List<LiveTvChannelEntity> channels;
  ...
  const LiveTvState.initial()
      : this._(isLoading: false, channels: const [], failure: null);
  const LiveTvState.loading()
      : this._(isLoading: true, channels: const [], failure: null);
  const LiveTvState.loaded(List<LiveTvChannelEntity> channels)
